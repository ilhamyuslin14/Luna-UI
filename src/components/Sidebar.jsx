    ...
    <div className="sidebar-content">
      <div className="sidebar-top">
        <div className="plan-card">
          ...
          <button className="upgrade-btn">Upgrade Paket</button>
        </div>
        ...
        <div className="sidebar-section">
          ...
          {menuItems.map(item => (
            <a
              ...
              href="#"
              data-menu={item.id}
              className={`menu-item${activeMenu === item.id || ((activeMenu === 'seleksi-detail' || activeMenu === 'setup-penilaian') && item.id === 'seleksi') ? ' active' : ''}`}
