...
const STATUS_STYLE = {
  ...
  Aktif: { text: 'var(--luna-semantic-success)', bg: '#E9F3ED', border: '#B1D6C1' },
...
export default function Navbar({ navigate, activeMenu = 'beranda_002', seleksiJabatan }) {
  ...
  const navTarget = { kandidat: 'kandidat_001', seleksi: 'seleksi_001', departemen: 'departemen_001' };
            ...
            {!hasQuery ? (
              <div className="srch-empty">
                <div className="srch-empty-icon">
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--luna-orange-500)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
