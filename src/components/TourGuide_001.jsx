...
const STEPS_001 = [
  ...
  { menu: 'sebar_001',    selector: '.menu-item[data-menu="sebar_001"]',   title: 'Menu Sebar',        description: 'Menu Sebar membantu lowongan Anda dilihat lebih banyak orang — sebar sendiri ke WhatsApp, Instagram, dan LinkedIn, atau titipkan ke akun loker mitra yang followers-nya ribuan.', position: 'right' },
  { menu: 'sebar_001',    selector: '.sebar-tabs',                        title: 'Akun Sendiri atau Akun Mitra', description: 'Pilih "Akun Sendiri" untuk salin teks siap pakai ke channel Anda, atau "Akun Mitra" untuk minta bantuan akun loker lain memposting lowongan Anda.', position: 'bottom' },
