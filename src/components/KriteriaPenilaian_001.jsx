    ...
    <div className="sd001-card">
      ...
      {isEditing ? (
        <div className="sd001-kriteria-content">
          <div className="sd001-ai-badge">
            <div className="sd001-ai-icon">
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                <path d="M6.5 0L7.64 4.86L13 6.5L7.64 8.14L6.5 13L5.36 8.14L0 6.5L5.36 4.86L6.5 0Z" fill="var(--luna-orange-400)" />
                <path d="M2 0.5L2.45 2.05L4 2.5L2.45 2.95L2 4.5L1.55 2.95L0 2.5L1.55 2.05L2 0.5Z" fill="var(--luna-orange-400)" opacity="0.6" />
              </svg>
            </div>
            <div className="sd001-ai-text-group">
              <p className="sd001-ai-title">Kriteria Berbasis AI</p>
              <p className="sd001-ai-desc">
        ...
        <div className="sd001-kriteria-content">
          ...
          <div className="sd001-kriteria-sections">
            {['Wajib', 'Nilai Tambah'].map(kat => {
              ...
              return (
                <div className="sd001-kriteria-section" key={kat}>
                  <div className="sd001-kriteria-header">
                    <h3 className={`sd001-kriteria-section-title ${kat === 'Wajib' ? 'primary' : 'neutral'}`}>{kat}</h3>
                    <span className="sd001-kriteria-bobot-label">Bobot Nilai</span>
                  </div>
                  <div className="sd001-kriteria-items">
                    {items.map(k => {
                      ...
                      return (
                        <div className="sd001-kriteria-item" key={k.id} onClick={() => startInlineEdit(k)}>
                          <ul className="sd001-kriteria-list"><li>{k.teks}</li></ul>
                          <span className={`sd001-bobot-badge ${k.bobot}`}>{BOBOT_LABEL[k.bobot]}</span>
                        </div>
                      );
                    })}
                  </div>
