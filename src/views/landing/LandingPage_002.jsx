...
const SEO_TITLE = 'LUNA – Aplikasi ATS Berbasis AI untuk Rekrutmen Modern';
const SEO_DESCRIPTION = 'LUNA adalah aplikasi ATS (Applicant Tracking System) berbasis AI. Screening CV otomatis, scoring kandidat akurat, dan pipeline rekrutmen dalam satu sistem ATS terpusat. Coba gratis 14 hari.';

export default function LandingPage_002({ navigate }) {
  const [activeSection, setActiveSection] = useState('');

  // SEO: title & meta description khusus varian ini — dipulihkan ke nilai
  // sebelumnya saat unmount, supaya tidak "membocorkan" perubahan ke halaman lain.
  useEffect(() => {
  ...
  return (
    <div className="lp-page lp-_001-container">
      ...
      <section className="lp-hero" id="hero">
        ...
        <div className="lp-hero-left">
          ...
          <div className="lp-hero-eyebrow-b">
            <span className="lp-hero-eyebrow-b-text">Applicant Tracking System</span>
            <div className="lp-hero-eyebrow-b-rule"></div>
          </div>
          <h1 className="lp-hero-title">
            Aplikasi ATS Berbasis AI<br />
      ...
      <section className="lp-features" id="fitur">
        ...
        <div className="lp-features-heading lp-hide-on-mobile">
          <h2 className="lp-features-title">Fitur Utama Aplikasi ATS LUNA V3</h2>
        ...
        <div className="lp-features-heading lp-show-on-mobile">
      ...
      <section className="lp-why" id="keunggulan">
        <div className="lp-why-inner">
          ...
          <div className="lp-why-left">
            {/* DESKTOP HEADING */}
            <div className="lp-why-heading lp-hide-on-mobile">
              <h2 className="lp-why-title">Mengapa LUNA V3 Berbeda?</h2>
              <p className="lp-why-subtitle">Kami bukan sistem ATS generik yang ditempel sebagai fitur tambahan di aplikasi HRIS. LUNA dirancang khusus sebagai mesin utama akuisisi talenta perusahaan Anda.</p>
            </div>
            {/* MOBILE HEADING */}
            <div className="lp-why-heading lp-show-on-mobile">
            ...
            <div className="lp-why-points">
              <div className="lp-why-point">
                ...
                <div className="lp-why-point-text lp-hide-on-mobile">
                ...
                <div className="lp-why-point-text lp-show-on-mobile">
                  <h4 className="lp-why-point-title">Candidate Warehouse</h4>
      ...
      <section className="lp-pricing" id="harga">
        ...
        <div className="lp-pricing-head">
          <div className="lp-pricing-texts lp-hide-on-mobile">
            <h2 className="lp-pricing-title">Skalakan Rekrutmen Tanpa Biaya Tersembunyi</h2>
            <p className="lp-pricing-subtitle">Pilih paket software ATS yang paling sesuai dengan volume hiring perusahaan Anda.</p>
          </div>
          <div className="lp-pricing-texts lp-show-on-mobile">
            <h2 className="lp-pricing-title">Biaya Transparan &amp; Fleksibel</h2>
            <p className="lp-pricing-subtitle">Software ATS fleksibel sesuai kebutuhan rekrutmen Anda.</p>
          </div>
          {/* Toggle */}
            ...
            <div className="lp-plan-inner">
              ...
              <div className="lp-plan-header">
                <div className="lp-plan-name-block">
                  ...
                  <p className="lp-plan-tagline lp-hide-on-mobile">Standardisasi proses hiring dengan AI untuk startup &amp; tim menengah.</p>
                  <p className="lp-plan-tagline lp-show-on-mobile">AI hiring untuk tim yang sedang berkembang.</p>
                </div>
      ...
      <footer className="lp-footer">
        <div className="lp-footer-top">
          <div className="lp-footer-brand">
            <div className="lp-footer-logo lp-hide-on-mobile">
              <img src="/assets/logos/luna-logo-clean.png" alt="LUNA" style={{ height: '76px', width: 'auto' }} />
            </div>
            <div className="lp-footer-logo lp-show-on-mobile">
              <img src="/assets/logos/luna-logo-clean.png" alt="LUNA" style={{ height: '46px', width: 'auto' }} />
            </div>
            <p className="lp-footer-desc">Software rekrutmen end-to-end bertenaga AI. Fokus pada manusia, biarkan AI menangani administrasinya.</p>
          </div>
