      ...
      <div className="bantuan-wrapper">
        <div className="bantuan-header-container">
          ...
          <div className="bh-content">
            ...
            <button className="bh-tour-btn" onClick={() => window.startProductTour && window.startProductTour()}>
        ...
        <div className="bantuan-cards-container">
          ...
          <div className="bantuan-card user-info-card">
            <div className="bc-header">
              ...
              {!isEditingProfile ? (
                <button className="bc-edit-btn" onClick={() => setIsEditingProfile(true)}>
                ...
                <div className="bc-edit-actions">
                  <button className="bc-edit-cancel-btn" onClick={() => setIsEditingProfile(false)}>Batal</button>
                  <button className="bc-edit-save-btn" onClick={() => setIsEditingProfile(false)}>Simpan</button>
                </div>
              )}
            </div>
            ...
            <div className="bc-rows-container">
              <div className="bc-row">
                <div className="bc-field">
                  ...
                  {!isEditingProfile ? (
                    <span className="bc-value">{profileData.nama}</span>
                  ) : (
                    <input type="text" className="bc-edit-input" value={profileData.nama} onChange={e => setProfileData({...profileData, nama: e.target.value})} />
                  )}
                </div>
                <div className="bc-field">
                  <span className="bc-label">Alamat Email</span>
                  {!isEditingProfile ? (
                    <span className="bc-value">{profileData.email}</span>
                  ) : (
                    <input type="email" className="bc-edit-input" value={profileData.email} onChange={e => setProfileData({...profileData, email: e.target.value})} />
                  )}
                </div>
              </div>
              ...
              <div className="bc-row">
                <div className="bc-field">
                  ...
                  {!isEditingProfile ? (
                    <span className="bc-value">{profileData.whatsapp}</span>
                  ) : (
                    <input type="text" className="bc-edit-input" value={profileData.whatsapp} onChange={e => setProfileData({...profileData, whatsapp: e.target.value})} />
                  )}
                </div>
                <div className="bc-field">
                  <span className="bc-label">Nama Perusahaan</span>
                  {!isEditingProfile ? (
                    <span className="bc-value">{profileData.perusahaan}</span>
                  ) : (
                    <input type="text" className="bc-edit-input" value={profileData.perusahaan} onChange={e => setProfileData({...profileData, perusahaan: e.target.value})} />
                  )}
                </div>
              </div>
              ...
              <div className="bc-row">
                <div className="bc-field">
                  ...
                  {!isEditingProfile ? (
                    <span className="bc-value">{profileData.industri}</span>
                  ) : (
                    <div className="bc-edit-select-wrapper">
                      <select className="bc-edit-select" value={profileData.industri} onChange={e => setProfileData({...profileData, industri: e.target.value})}>
                ...
                <div className="bc-field">
                  ...
                  {!isEditingProfile ? (
                    <span className="bc-value">{profileData.karyawan}</span>
                  ) : (
                    <div className="bc-edit-select-wrapper">
                      <select className="bc-edit-select" value={profileData.karyawan} onChange={e => setProfileData({...profileData, karyawan: e.target.value})}>
              ...
              <div className="bc-row">
                <div className="bc-field" style={{ flex: 'none', width: 'calc(50% - 8px)' }}>
                  <span className="bc-label">Lokasi</span>
                  {!isEditingProfile ? (
                    <span className="bc-value">{profileData.lokasi}</span>
                  ) : (
                    <input type="text" className="bc-edit-input" value={profileData.lokasi} onChange={e => setProfileData({...profileData, lokasi: e.target.value})} />
                  )}
                </div>
              </div>
            </div>
