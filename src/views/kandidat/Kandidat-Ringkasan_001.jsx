                    ...
                    <div className="kd001-edu-item-content">
                      ...
                      {(sert.deskripsi?.[0]) && (
                        <div className="kd001-exp-desc-display">
                          <div className={`kd001-exp-desc-text${expandedSert.has(sert.id) ? '' : ' kd001-exp-desc-collapsed'}`}
                ...
                {editingExpId === exp.id ? (
                  ...
                  <div className="kd001-edu-item kd001-exp-item kd001-item-clickable" onClick={() => startInlineEditExp(exp)}>
                    <div className="kd001-edu-item-content">
                      ...
                      {exp.deskripsi?.[0] && (
                        <div className="kd001-exp-desc-display">
                          <div className={`kd001-exp-desc-text${expandedExp.has(exp.id) ? '' : ' kd001-exp-desc-collapsed'}`}
          ...
          <div className="kd001-edu-body">
            ...
            {addingEdu && (
              <div className="kd001-edu-form-card">
                ...
                <div className="kd001-entry-row-actions">
                  <button className="sd001-edit-cancel-btn" onClick={() => { setAddingEdu(false); setNewEdu({ institusi: '', jenjang: '', tglMulai: '', tglSelesai: '' }); }}>Batal</button>
                ...
                {editingEduId === edu.id ? (
                  ...
                  <div className="kd001-edu-item kd001-item-clickable" onClick={() => startInlineEditEdu(edu)}>
                    <div className="kd001-edu-item-content">
                      ...
                      <span className="kd001-edu-item-sub">{edu.gelar}</span>
