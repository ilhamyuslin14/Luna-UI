...
export default function LowonganDetail_002({ seleksiId, jabatan: initialJabatan = 'Project Manager', navigate, back, activeTab = 'ringkasan', onTabChange }) {
  ...
  const handleDuplicate = async () => {
    ...
    try {
      ...
      invalidate('seleksi');
      navigate('lowongan-detail_002', { seleksiId: duplicated.id, jabatan: duplicated.jabatan, activeTab: 'ringkasan' });
    } catch (err) {
      console.error(err);
