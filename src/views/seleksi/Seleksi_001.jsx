                          ...
                          >
                            <div className="lw001-board-card-top">
                              <span
                                ...
                                onClick={() => navigate('seleksi-detail_001', { seleksiId: card.id, jabatan: card.posisi, activeTab: card.kandidat > 0 ? 'kandidat' : 'ringkasan' })}
                              >
                                {card.posisi}
                              </span>
                            ...
                            <div className="lw001-board-card-footer">
                              ...
                              <button className="lw001-board-card-detail-btn" disabled={card.arsip} onClick={card.arsip ? undefined : () => navigate('seleksi-detail_001', { seleksiId: card.id, jabatan: card.posisi, activeTab: card.kandidat > 0 ? 'kandidat' : 'ringkasan' })} style={card.arsip ? { opacity: 0.4, cursor: 'not-allowed' } : {}}>Detail</button>
                            </div>
                          </div>
                        );
                      })}
