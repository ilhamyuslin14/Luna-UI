...
export default function SeleksiKandidat({ navigate }) {
  ...
  return (
    ...
    >
      ...
      <div className="sdk-actions-bar">
        <div className="sdk-right-actions" style={{ marginLeft: 'auto' }}>
          ...
          {selected.size > 0 && (
            <div className="sdk-bulk-container">
              <button
                ...
                onClick={(e) => { e.stopPropagation(); setShowBulk(v => !v); }}
              >
              ...
              {showBulk && (
                <div className="sdk-bulk-dropdown">
                  <button className="sdk-bulk-item" onClick={() => { alert(`${selected.size} kandidat dipindahkan alur!`); setSelected(new Set()); setShowBulk(false); }}>
                    Pindahkan Alur
                  </button>
                  <div className="sdk-bulk-sep" />
                  <button className="sdk-bulk-item" onClick={() => { alert(`${selected.size} kandidat diarsipkan!`); setSelected(new Set()); setShowBulk(false); }}>
                    Arsipkan
                  </button>
                </div>
              )}
          ...
          <div className="sdk-filter-container">
            <button
              className={`sdk-btn-filter${showFilter ? ' active' : ''}`}
            ...
            {showFilter && (
              <div className="sdk-filter-dropdown" onClick={e => e.stopPropagation()}>
                <div className="sdk-filter-col">
                  <span className="sdk-filter-col-title">Skor</span>
                  {['High', 'Moderate', 'Low'].map(s => (
                    <div className="sdk-filter-item" key={s}>
                      <span className="sdk-filter-box" />
                      <span className="sdk-filter-label">{s}</span>
                    </div>
                  ))}
                </div>
